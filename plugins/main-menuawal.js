...
{title: `✨ ${emot} OWNER BOT`, rowId: ".owner", description: "Pemilik bot"},
},{
title: `${htki} SUPPORT ${htka}`,
rows: [
{title: `🕹️ ${emot} DONASI`, rowId: ".donasi", description: 'Support Bot'},
]
},{
...
{title: `${emot} Stikers`, rowId: ".? stiker", description: "Buat Sticker di Bot, jangan spam ya kak"},
...
{title: `${emot} Database`, rowId: ".? database", description: "Database bot"},
...
{title: `\n${emot} No Category`, rowId: ".? nocategory", description: "Fitur tanpa kategori!"},
] },
]
...
const listMessage = {
text: tek,
footer: '📮 *Catatan:* Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada Owner',
