...
let modes = {
    noob: [-3, 3, -3, 3, '+-', 200, 10],
    easy: [-10, 10, -10, 10, '*/+-', 200, 40],
    medium: [-40, 40, -20, 20, '*/+-', 300, 150],
    hard: [-100, 100, -70, 70, '*/+-', 700, 350],
    extreme: [-999999, 999999, -999999, 1000, '*/', 20, 10],
    impossible: [-99999999999, 99999999999, -99999999999, 999999999999, '*/', 400, 500],
    impossible2: [-999999999999999, 999999999999999, -999, 999, '/', 300, 1000]
}
