...
conn.send3ButtonImg(m.chat, `${pickRandom(flaaa2)}` + `${ucapan()} ` + `${name}`, nth, rules, 'Menu', '.menu', 'Owner', '.owner', 'Ping Bot', '.ping', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
