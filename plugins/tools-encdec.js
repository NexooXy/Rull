...
let frep = { contextInfo: { externalAdReply: {title: global.wm, body: 'By CloudBot', sourceUrl: sgc, thumbnail: fs.readFileSync('./thumbnail.jpg')}}}
let fdoc = {quoted:{key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${command}`}}}}

if (command == 'dec32') {
if (!text) throw `Contoh penggunaan ${usedPrefix}${command} Cloud`
...
if (command == 'enc32') {
if (!text) throw `Contoh penggunaan ${usedPrefix}${command} CloudBot`
