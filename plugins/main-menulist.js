...
rows: [
{title: `⚡ ${emot} Ping Bot`, rowId: ".speed", description: "Kecepatan Bot"},
{title: `💌 ${emot} Creator`, rowId: ".owner", description: "Menampilkan Pemilik Cloud Bot"},
]
},{
title: `${htki} Support ${htka}`,
rows: [
{title: `💹 ${emot} DONASI`, rowId: ".donasi", description: 'Donation'},
]
},{
...
{title: `${emot} Game`, rowId: ".? game", description: "Game menu"},
...
{title: `${emot} Nsfw`, rowId: ".? nsfw", description: "Nsfw Menu"},
