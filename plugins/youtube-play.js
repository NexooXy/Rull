...
⏲️ *Publikasi:* ${publishedTime}
⌚ *Durasi:* ${durationH}
👁️ *Penonton:* ${viewH}
  `
  let buttons = [{ buttonText: { displayText: 'Video' }, buttonId: `${usedPrefix}ytv ${url}` }, { buttonText: { displayText: 'Cari Di Youtube' }, buttonId: `${usedPrefix}yts ${text}` }]
